        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Search through 50M+ verified trade records from 200+ countries</p>
            </div>
            <div className="flex items-center space-x-2 text-sm text-gray-600 bg-emerald-50 px-4 py-2 rounded-lg">
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            {/* SearchPanel from main branch - preserve working logic */}
            <div className="p-6">
              <SearchPanel />
            </div>
          </div>
