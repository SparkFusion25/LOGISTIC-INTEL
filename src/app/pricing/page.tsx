...
const pricingTiers: PricingTier[] = [
  {
    ...
    price: '$99',
    period: '/month',
    description: 'Perfect for sales professionals getting started with trade intelligence',
    features: [
      '100 trade intelligence searches',
      '50 contact lookups',
      '10 data exports',
  ...
  },
  {
    ...
    price: '$299',
    period: '/month',
    description: 'Ideal for sales professionals who need enriched contact data and automation',
    features: [
      '500 trade intelligence searches',
      '250 enriched contact lookups',
      '50 data exports',
  ...
  },
  {
    ...
    price: '$899',
    period: '/month',
    description: 'Everything you need for a team of 5 with full automation and insights',
    features: [
      '2,500 trade intelligence searches',
      '1,000 enriched contact lookups',
      '250 data exports',
