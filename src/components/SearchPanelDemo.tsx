              ...
              <table className="w-full min-w-[600px]">
                ...
                <tbody className="divide-y">
                  {companies.map(company => (
                    <tr 
                      key={company.company_name} 
                      className="hover:bg-gray-50 cursor-pointer  const [viewMode, setViewMode] = useState('cards');
        ...
        if (userPlan === 'pro' || userPlan === 'enterprise') {
          try {
            ...
            if (enrichResponse.ok) {
              addNotification('Contact enrich'use client';
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4">
                        <div className="bg-blue-50 rounded-lg p-3">
                          ...
                          <p className="text-sm lg:text-lg font-bold">{Math.round((company.total_shipments || 0) / 12)} shipments</p>
                        </div>
                        <div className="bg-green-50 rounded-lg p-3">
                          <p className="text-xs lg:text-sm text-green-600 font-medium">Quarterly Value</p>
                          <p className="text-sm lg:text-lg font-bold">${((company.total_value_usd || 0) / 4 / 1000000).toFixed(1)}M</p>
                        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                ...
                <tbody className="divide-y">
                  {companies.map(company => (
                    <tr key={company.company_name} className="hover:bg-gray-50"                      onClick={() => handleCompanyClick(company)}
                    >
...
export default SearchPanelDemo;-lg lg:text-xl font-bold">{company.total_shipments || 0}</p>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3">
                        <div className="flex items-center gap-2 text-gray-600 mb-1">
                          <DollarSign className="w-3 h-3 lg:w-4 lg:h-4" />
