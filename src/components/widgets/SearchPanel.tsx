...
export default function SearchPanel() {
  ...
  // Load current user for gating logic
  useEffect(() => {
    (async () => {
      try {
            ...
            <div className="p-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {currentUser?.isAdmin || currentUser?.plan === 'enterprise' || currentUser?.plan === 'pro' ? (
                    <div className="mt-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 text-sm text-green-700 mb-2">
                            <Building2 className="w-4 h-4" />
                            <span className="font-bold">✅ Premium Contact Intelligence Unlocked</span>
                          </div>
                          <p className="text-sm text-green-700 mb-3">
                            You can enrich and view contact details for this company.
                          </p>
                        </div>
                ...
                <div className="flex items-center justify-between mt-3">
                  <div className="text-sm text-gray-600">
                    <span className="font-medium">Mode:</span> {record.shipment_type?.toUpperCase() || 'N/A'}
                  </div>
                  <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                    <button
                      onClick={() => toggleContactCard(record.unified_company_name)}
                      className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md border transition-colors whitespace-nowrap ${
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md bg-indigo-600 text-white hover:bg-indigo-700 transition-colors shadow-sm whitespace-nowrap"
                    >
